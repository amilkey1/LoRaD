...
| ignore       |  Prior		                    |
| positive     |  alpha		                    |
| simplex      |  edge_length_proportions.1.	|	
| simplex      |  edge_length_proportions.2.	|
| simplex      |  edge_length_proportions.3.	|
| simplex      |  edge_length_proportions.4.	|
| simplex      |  edge_length_proportions.5.	|
| simplex      |  edge_length_proportions.6.	|
| simplexfinal |  edge_length_proportions.7.	|
| ignore       |  edgelens.1.	                |
| ignore       |  edgelens.2.	                |	
| ignore       |  edgelens.3.		              |
| ignore       |  edgelens.4.		              |
...
```{r}
lorad_estimate(gtrigsamples, colspec, 0.5, "left", 0.1)
```
