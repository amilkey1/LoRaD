...
* **edge length**, $v$ : the distance measured in expected substitutions per site
...
All columns labeled **posterior** will be summed to create the log posterior kernel (product of likelihood and joint prior).
